...
#import "SMScaleAnimation.h"

@implementation SMScaleAnimation
...
- (void) animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext fromView:(UIView *)fromView toView:(UIView *)toView
{
    ...
    CGFloat zoomingScale = (self.type == SMScaleAnimationFadeIn) ? 0.8 : 2.0;
    CGFloat springScale = (self.type == SMScaleAnimationFadeIn) ? 1.2 : 2.2;
