...
@interface SMSlideAnimation()
@property (assign, nonatomic) BOOL shouldCompleteTransition;
@end

@implementation SMSlideAnimation
...
- (void) handleGesture:(UIPanGestureRecognizer*)gestureRecognizer
{
    ...
    BOOL horizontalPan = (self.type == SMSlideAnimationFromLeft || self.type == SMSlideAnimationFromRight);
    ...
    switch (gestureRecognizer.state) {
        case UIGestureRecognizerStateBegan: {
            ...
            if (horizontalPan){
                if ((self.type == SMSlideAnimationFromLeft && rightToLeftSwipe) ||
                    (self.type == SMSlideAnimationFromRight && leftToRightSwipe)){
                    [self dismissViewController];
                }
            } else {
                if ((self.type == SMSlideAnimationFromTop && bottomToTopSwipe) ||
                    (self.type == SMSlideAnimationFromBottom && topToBottomSwipe)){
                    [self dismissViewController];
                }
            }
